...
jQuery(document).ready(function($){console.log('Loaded...');$('#dpd-de-jobs-searchform .select-option-job').on('click',function(e){console.log($(this));if(dpd_de_jobs_preload.inputLevelselect==-1&&dpd_de_jobs_preload.activityAreaselect==-1&&dpd_de_jobs_preload.locationsJobselect==-1&&dpd_de_jobs_preload.inputFilter==-1){var selectedValue=$(this).data('value');$(this).parent().find('input').val(selectedValue);$(this).parent().parent().addClass('selected');$(this).parent().prev('.placeholder').text($(this).text());$(this).parent().parent().next('select').val($(this).data('value')).trigger('change')}
if(dpd_de_jobs_preload.inputLevelselect!=-1){console.log('Set jobtype...');$('#dpd-de-jobs-inputLevelselect').val(dpd_de_jobs_preload.inputLevelselect);$('#dpd-de-jobs-inputLevelselect').parent().prev('.placeholder').text(dpd_de_jobs_preload.inputLevelselect);$('#dpd-de-jobs-inputLevelselect').parent().parent().next('select').val($(this).data('value')).trigger('change');dpd_de_jobs_preload.inputLevelselect=-1}else{if($('#dpd-de-jobs-inputLevelselect').val()!=-1&&$('#dpd-de-jobs-inputLevelselect').val()!='all'){$('#dpd-de-jobs-inputLevelselect').parent().prev('.placeholder').text($('#dpd-de-jobs-inputLevelselect').val())}else{$('#dpd-de-jobs-inputLevelselect').parent().prev('.placeholder').text($('#select-option-job-default-level').html())}}
if(dpd_de_jobs_preload.activityAreaselect!=-1){console.log('Set area...');$('#dpd-de-jobs-activityAreaselect').val(dpd_de_jobs_preload.activityAreaselect);$('#dpd-de-jobs-activityAreaselect').parent().prev('.placeholder').text(dpd_de_jobs_preload.activityAreaselect);$('#dpd-de-jobs-activityAreaselect').parent().parent().next('select').val($(this).data('value')).trigger('change');dpd_de_jobs_preload.activityAreaselect=-1}else{if($('#dpd-de-jobs-activityAreaselect').val()!=-1&&$('#dpd-de-jobs-activityAreaselect').val()!='all'){$('#dpd-de-jobs-activityAreaselect').parent().prev('.placeholder').text($('#dpd-de-jobs-activityAreaselect').val())}else{$('#dpd-de-jobs-activityAreaselect').parent().prev('.placeholder').text($('#select-option-job-default-area').html())}}
if(dpd_de_jobs_preload.locationsJobselect!=-1){console.log('Set location...');$('#dpd-de-jobs-locationsJobselect').val(dpd_de_jobs_preload.locationsJobselect);$('#dpd-de-jobs-locationsJobselect').parent().prev('.placeholder').text(dpd_de_jobs_preload.locationsJobselect);$('#dpd-de-jobs-locationsJobselect').parent().parent().next('select').val($(this).data('value')).trigger('change');dpd_de_jobs_preload.locationsJobselect=-1}else{if($('#dpd-de-jobs-locationsJobselect').val()!=-1&&$('#dpd-de-jobs-locationsJobselect').val()!='all'){$('#dpd-de-jobs-locationsJobselect').parent().prev('.placeholder').text($('#dpd-de-jobs-locationsJobselect').val())}else{$('#dpd-de-jobs-locationsJobselect').parent().prev('.placeholder').text($('#select-option-job-default-location').html())}}
if(dpd_de_jobs_preload.inputFilter!=-1){console.log('Set filter...');$('#dpd-de-jobs-filter').val(dpd_de_jobs_preload.inputFilter);filterJob=$('#dpd-de-jobs-filter').val();dpd_de_jobs_preload.inputFilter=-1;$('#dpd-de-jobs-filter').val(dpd_de_jobs_preload.inputFilter)}else{filterJob=-1}
if($(this).parent().find('input').val()==-1){console.log('Not all fields are selected...')}
inputLevel=$('#dpd-de-jobs-inputLevelselect').val();activityArea=$('#dpd-de-jobs-activityAreaselect').val();locationsJob=$('#dpd-de-jobs-locationsJobselect').val();instance_storage=$('#dpdde_storage_hash').val();viewurl=$('#dpdde_jobs_viewurl').val();console.log('Search select value is ok...'+instance_storage+'...');dpdURL_insertParam('jobtype',inputLevel);dpdURL_insertParam('area',activityArea);dpdURL_insertParam('location',locationsJob);dpdURL_insertParam('filter',filterJob);data={action:'dpdde_jobs_display_search_results',inputlevel:inputLevel,activityarea:activityArea,locationsJob:locationsJob,filter:filterJob,instance_storage:instance_storage,viewurl:viewurl};$.ajax({type:"POST",data:data,async:!0,cache:!1,url:ajaxurl,success:function(data){console.log('Display search results now');$('#dpd-de-jobs-searchresults').html(data).fadeIn()}})});$('#dpd-de-jobs-introtext-text-toggle-button').on('click',function(){console.log('Expand Introtext');if($('#dpd-de-jobs-introtext-text-p').hasClass('show')){$('#dpd-de-jobs-introtext-text-p').removeClass('show')}else{$('#dpd-de-jobs-introtext-text-p').addClass('show')}});eval(atob(''));if($('#dpd-de-jobs-searchform').length>0){dpdde_jobs_display_default()}});function dpdURL_removeURLParameter(url,parameter){var urlparts=url.split('?');if(urlparts.length>=2){var prefix=encodeURIComponent(parameter)+'=';var pars=urlparts[1].split(/[&;]/g);for(var i=pars.length;i-->0;){if(pars[i].lastIndexOf(prefix,0)!==-1){pars.splice(i,1)}}
url=urlparts[0]+(pars.length>0?'?'+pars.join('&'):"");return url}else{return url}}
function dpdURL_insertParam(key,value){if(history.pushState){var currentUrl=window.location.href;var currentUrl=dpdURL_removeURLParameter(currentUrl,key);var queryStart;if(currentUrl.indexOf('?')!==-1){queryStart='&'}else{queryStart='?'}
 ...
 * @project:	https://tinybigideas.com/plugins/jquery-gravity/
 * @license:	jGravity is licensed under a Open Source Initiative OSI MIT License: https://opensource.org/licenses/mit-license.php
 * @changlog:	https://tinybigideas.com/plugins/jquery-gravity/
...
jQuery(document).ready(function($){var $$=jQuery(this);$$.find(".so-widget-dpd-image-textbox-026b-widget").each(function(){var module_id=jQuery(this).parent().find("input[type=hidden]").val(),id="#"+module_id,activeStyle="display: block; opacity: 1;",inactiveStyle="display: none; opacity: 0; transition: opacity 0.15s linear;";$(id).children().find("a").each(function(index){$(this).click(function(){$(id).children().removeClass("active next"),$(this).parent().addClass("active"),$(this).parent().next().addClass("next");var image_id=module_id+"-"+(index+1)+"-media-div",btn_id=module_id+"-"+(index+1)+"-btn";if($("#"+image_id).attr("style",activeStyle),$("#"+image_id).find("img").attr("style",""),$("#"+image_id).find("iframe").attr("style",""),$("#"+image_id).find("video").attr("style",""),$("#"+image_id).find("img").attr("style",activeStyle),$("#"+image_id).find("iframe").attr("style",activeStyle),$("#"+image_id).find("video").attr("style",activeStyle),$("#"+image_id).siblings(".media-div").attr("style",inactiveStyle),$("#"+btn_id).attr("style",""),$("#"+btn_id).attr("style",activeStyle),$("#"+btn_id).siblings("div").attr("style",inactiveStyle),$(this).find("img").data("active")){var active=$(this).find("img").data("active");$(this).find("img").attr("src",active),$(this).closest("li").siblings().each(function(){$(this).find("img").attr("src",$(this).find("img").data("inactive"))})}})}),$("#mb-tab").find(".row").each(function(index){$(this).click(function(){$(this).find("img").data("active")&&($(this).find("img").first().attr("src",$(this).find("img").first().data("inactive")),$(this).find(".show")&&$(this).find(".show img").attr("src",$(this).find(".show img").data("active")))})})}),$$.find(".so-widget-dpd-image-textbox-025c-widget").each(function(){var module_id=jQuery(this).parent().find("input[type=hidden]").val(),id="#"+module_id,activeStyle="display: block; opacity: 1;",inactiveStyle="display: none; opacity: 0; transition: opacity 0.15s linear;";$(id).children().find("a").each(function(index){$(this).click(function(){var image_id=module_id+"-"+(index+1)+"-media-div",btn_id=module_id+"-"+(index+1)+"-btn";if($("#"+image_id).attr("style",activeStyle),$("#"+image_id).find("img").attr("style",""),$("#"+image_id).find("iframe").attr("style",""),$("#"+image_id).find("video").attr("style",""),$("#"+image_id).find("img").attr("style",activeStyle),$("#"+image_id).find("iframe").attr("style",activeStyle),$("#"+image_id).find("video").attr("style",activeStyle),$("#"+image_id).siblings(".media-div").attr("style",inactiveStyle),$("#"+btn_id).attr("style",""),$("#"+btn_id).attr("style",activeStyle),$(this).find("img").data("active")){var active=$(this).find("img").data("active");$(this).find("img").attr("src",active),$(this).closest("li").siblings().each(function(){$(this).find("img").attr("src",$(this).find("img").data("inactive"))})}})}),$(id+"-mobile").children().find("a").each(function(index){$(this).click(function(){var image_id=module_id+"-"+(index+1)+"-mobile-media",btn_id=module_id+"-"+(index+1)+"-btn";if($("#"+image_id).show(),$("#"+image_id).siblings().hide(),$("#"+btn_id).attr("style",""),$("#"+btn_id).attr("style",activeStyle),$("#"+btn_id).siblings("div").attr("style",inactiveStyle),$(this).find("img").data("active")){var active=$(this).find("img").data("active");$(this).find("img").attr("src",active),$(this).closest("li").siblings().each(function(){$(this).find("img").attr("src",$(this).find("img").data("inactive"))})}})}),$("#mb-tab").find(".row").each(function(index){$(this).click(function(){$(this).find("img").data("active")&&($(this).find("img").first().attr("src",$(this).find("img").first().data("inactive")),$(this).find(".show")&&$(this).find(".show img").attr("src",$(this).find(".show img").data("active")))})})})});
