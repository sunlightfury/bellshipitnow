			...
			<div class="row">
				<div class="col-lg-6">
					<div class="entry-text">
						<span class="ghb-content-callout wow fadeInUp">If It Packs, It Bellshipitnow</span>
						<h1 class="heading-h1 text-white wow fadeInUp" data-wow-delay="0.3s">Whatever you're sending. If It Packs, It Bellshipitnow.</h1>
						<div class="heading-h4 wow fadeInUp" data-wow-delay="0.6s">We've removed the guesswork. Pay flat Bellshipitnow rates based on size, up to 5kg for sending within Australia.</div>
						<div class="link mt-4 wow fadeInUp" data-wow-delay="0.9s">
				...
				<div class="col-lg-6">
					<div class="img">
						<img src="../uploads/photo-teddy-bear-parcel-box-mobile.jpg" alt="">
					</div>
				</div><!-- col -->
			</div><!-- row -->
		</div> <!-- END container-->
					...
					<div class="col-lg-4">
						<div class="card">
						  <div class="img p-3 bg-red">
					  		<img src="../uploads/illu-gach-kangaroo-aussie-map.svg" class="card-img-top" alt="...">
						  </div>
						  <div class="card-body">
						    <h5 class="card-title wow fadeInUp">The Great Aussie Coin Hunt is on!</h5>
						    <p class="card-text wow fadeInUp" data-wow-delay="0.3s">
						    ...
						    <a class="c-btn text-pink wow fadeInUp" data-wow-delay="0.6s" href="javascript:void(0);">View the coins</a>
						  </div>
						</div><!-- card -->
					</div><!-- col -->
					...
					<div class="col-lg-4">
						<div class="card">
						  <div class="img p-3 bg-lblue">
					  		<img src="../uploads/illu-eofy.svg" class="card-img-top" alt="...">
						  </div>
						  <div class="card-body">
						    <h5 class="card-title wow fadeInUp" data-wow-delay="0.3s">Get a Post Office in your pocket</h5>
						    <p class="card-text wow fadeInUp" data-wow-delay="0.6s">
						    	Use our app to track parcels, manage deliveries and add delivery addresses while you're on the go.
						    </p>
						    <a class="c-btn text-pink wow fadeInUp" data-wow-delay="0.9s" href="javascript:void(0);">Download the app now</a>
						  </div>
						</div><!-- card -->
					</div><!-- col -->
					...
					<div class="col-lg-4">
						<div class="card">
						  <div class="img p-3 bg-lgreen">
					  		<img src="../uploads/Sea-Mail.svg" class="card-img-top" alt="...">
						  </div>
						  <div class="card-body">
						    <h5 class="card-title wow fadeInUp" data-wow-delay="0.9s">Sending overseas this Christmas?</h5>
						    <p class="card-text wow fadeInUp" data-wow-delay="1.2s">
						    	If you're sending by International Economy Sea Mail, be sure to post your parcel before our cut-off dates.
						    </p>
						    <a class="c-btn text-pink wow fadeInUp" data-wow-delay="1.5s" href="javascript:void(0);">View cut-off dates</a>
						  </div>
						</div><!-- card -->
					</div><!-- col -->
				</div><!-- row -->
