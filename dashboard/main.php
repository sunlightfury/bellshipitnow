					...
					<div class="card-body">
						<form class="xform" id="admin_form" method="post">
							...
							<div class="row">
								...
								<section class="col col-4"> <img src="../thumbmaker.php?src=<?php echo UPLOADURL;?><?php echo ($row->avatar) ? $row->avatar : "blank.png";?>&amp;w=40&amp;h=40&amp;s=1&amp;a=t1" alt="customer support with one of our shipping agents" title="" class="avatar" /> </section>
							</div>
							<div class="row">
								<section class="col col-4">
