									...
									<div class="d-flex">
										<div class="mr-auto">
											<div class="form-group">
												<a href="#"><img src='assets/images/alert/twilio-logo.png' width='121' alt='Discounted shipping rates'/>  <?php echo $lang['tools-twilio7'] ?></a> 
											</div>
										</div>
									</div>
								</div>
							...
							<table id="dt-material-checkbox" class="table table-bordered table-condensed table-hover table-striped">
								...
								<div class="m-t-0">
									<div class="d-flex">
										<div class="mr-auto">
											<div class="form-group">
												<a href="#"><img src='assets/images/alert/nexmo-logo.png' width='105' alt='US sales tax-free shopping'/>  <?php echo $lang['tools-nexmo7'] ?></a> 
											</div>
										</div>
									</div>
								</div>
