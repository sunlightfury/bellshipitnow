							...
							<form id="dForm" method="post" style="padding:0;">
								<div class="input-daterange input-group" id="date-range">
									...
									<div class="input-group-append">
										<a target="_blank" href="javascript:shipmentdeliveredPDF();"><img src="assets/images/pdf.png" alt="guarantee a safe and fast shipping to any location" border="0" height="43" width="38" /></a>
									</div>
								</div>
							</form>	
						</div>
					...
					<table id="zero_config" class="table table-bordered table-condensed table-hover table-striped">
						...
						<tbody>
							...
							<tr>
								<td colspan="7">
								<?php echo "
									<i align='center' class='display-3 text-warning d-block'><img src='assets/images/alert/ohh_manage_shipment.png' width='130' alt='quick shipping access to our members worldwide'/></i>
									",false;?>
								</td>
							</tr>
							<?php else:?>
