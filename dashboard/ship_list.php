					...
					<table id="zero_config" class="table table-bordered table-condensed table-hover table-striped">
						...
						<tbody>
							<tr>
								...
								<td colspan="7">
									<?php echo "
									<i align='center' class='display-3 text-warning d-block'><img src='assets/images/alert/ohh_shipment.png' width='160' alt='US sales tax-free shopping'/></i>
									</br>
						...
						<tbody>
							<tr>
								...
								<tr>
									<td colspan="2">
									<?php echo "
									<i align='center' class='display-3 text-warning d-block'><img src='assets/images/alert/ohh_shipment_online.png' width='193' alt='US sales tax-free shopping'/></i>
									</br>
									<p style='font-size: 20px; -webkit-font-smoothing: antialiased; color: #737373;' align='center'>".$lang['oohhship']."</p>
