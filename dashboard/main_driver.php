					...
					<div class="card-body">
						<form class="xform" id="admin_form" method="post">
							...
							<div class="row">
								...
								<section class="col col-4"> <img src="../thumbmaker.php?src=<?php echo UPLOADURL;?><?php echo ($row->avatar) ? $row->avatar : "blank.png";?>&amp;w=40&amp;h=40&amp;s=1&amp;a=t1" alt="shipping unique tracking number" title="" class="avatar" /> </section>
							</div>
							<div class="row">
								<section class="col col-4">
					...
					<div class="card-body">
						<form class="xform" id="admin_form" method="post">
							...
							<div class="row">
								<section class="col col-3">
									<label class="input">
										<input name="code_phone" list="browser" autocomplete="off" placeholder="Phone Area Codes" required="required">	
										<datalist id="browser">
