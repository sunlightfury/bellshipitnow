...
<div id="page-wrap">
    <table width="100%">
        <tr>
			...
			<td style="border: 0;  text-align: center" width="56%">
				<?php echo $lang['inv-shipping1'] ?>: <?php echo '230721000452<br>';//$core->c_nit; ?>				 
				<?php echo $lang['inv-shipping2'] ?>: <?php echo '1-844-227-4641'; //$core->c_phone; ?></br>
				<?php echo $lang['inv-shipping3'] ?>: <?php echo 'support@bellshipitnow.com'; //$core->site_email; ?></br>
				<?php echo $lang['inv-shipping4'] ?>: <?php echo '228 Park Ave A # 698760 <br>  <br>'; //$core->c_address; ?> - <?php echo 'United States'; //$core->c_country; ?>-<?php echo 'New York, New York 10003'; //$core->c_city; ?>
			</td>
    ...
    <table id="items">
		...
		<tr class="item-row">
            ...
            <td align="right"><span class="price"> <?php echo round_out($row->r_custom); ?> </span></td>
        </tr>
        <tr>
			<td align="right" class="blank"> </td>
			<td align="right" class="blank"> </td>
			<td align="right" colspan="2" class="shipping-line">Shipping Charges +</td>
			<td align="right" class="shipping-value">
                <div id="shipping"> <?php echo round_out($row->shipping_charges); ?> </div>
            </td>
		</tr>
        <tr>
			<td align="right" class="blank"> </td>
			<td align="right" class="blank"> </td>
			<td align="right" colspan="2" class="handling-line">Handling Charges +</td>
			<td align="right" class="handling-value">
                <div id="handling"> <?php echo round_out($row->handling_charges); ?> </div>
            </td>
		</tr>
        <tr>
			<td align="right" class="blank"> </td>
			<td align="right" class="blank"> </td>
			<td align="right" colspan="2" class="consolidation-line">Consolidation Charges +</td>
			<td align="right" class="consolidation-value">
                <div id="consolidation"> <?php echo round_out($row->consolidation_charges); ?> </div>
            </td>
		</tr>
        <tr>
			<td align="right" class="blank"> </td>
			<td align="right" class="blank"> </td>
			<td align="right" colspan="2" class="tca-line">TCA Charges +</td>
			<td align="right" class="tca-value">
                <div id="tca"> <?php echo round_out($row->tca_charges); ?> </div>
            </td>
		</tr>
		<tr>
			<td align="right" class="blank"> </td>
			...
			<td align="right" class="total-value">
                <div id="total"> <?php echo round_out($row->tax_charges); ?> </div>
            </td>
		</tr>
		<tr>
			<td align="right" class="blank"> </td>
			...
			<td align="right" class="total-value">
                <div id="total"> <?php echo round_out($row->insurance_charges); ?> </div>
            </td>
		</tr>
		<tr>
			<td class="blank"> </td>
