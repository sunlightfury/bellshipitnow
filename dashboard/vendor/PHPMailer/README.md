...
$mail->Host = 'smtp1.bellshipitnow.com;smtp2.bellshipitnow.com';  // Specify main and backup SMTP servers
$mail->SMTPAuth = true;                               // Enable SMTP authentication
$mail->Username = 'user@bellshipitnow.com';                 // SMTP username
$mail->Password = 'secret';                           // SMTP password
$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to

$mail->From = 'from@bellshipitnow.com';
$mail->FromName = 'Mailer';
$mail->addAddress('joe@example.net', 'Joe User');     // Add a recipient
$mail->addAddress('ellen@bellshipitnow.com');               // Name is optional
$mail->addReplyTo('info@bellshipitnow.com', 'Information');
$mail->addCC('cc@bellshipitnow.com');
$mail->addBCC('bcc@bellshipitnow.com');
