                                    ...
                                    <table id="zero_config" class="table table-bordered table-condensed table-hover table-striped">
                                        <thead>
											<tr>
                                                ...
                                                <th class="text-center"><b><?php echo "Customer Number"; ?></b></th>
										...
										<tbody>
											...
											<tr>
												<td colspan="6">
												<?php echo "
												<i align='center' class='display-3 text-warning d-block'><img src='assets/images/alert/ohh_shipment.png' width='130' alt='automatically notified at the arrival of every package'/></i>
												</br>
											...
											<td><a href="customer.php?do=main_client&id=<?php echo $row->id;?>"><?php echo $row->customer_number;?></a></td>
