-- --------------------------------------------------------------------------------
-- 
-- @version: ayibobo.sql Apr 8, 2019 15:22 gewa
-- @Deprixa Pro
-- @author jaomweb.info.
-- @copyright 2019
-- 
...
INSERT INTO `news` (`id`, `title`, `body`, `author`, `created`, `active`) VALUES ('6', 'Welcome to our Client Area!', '&lt;p&gt;We are pleased to announce the new release DEPRIXA PRO v3.2.6.2&lt;br&gt;&lt;/p&gt;', 'Administrator', '2019-02-02', '1');
...
INSERT INTO `sms_templates` (`id`, `name`, `help`, `body1`, `body2`, `body3`, `active`) VALUES ('1', 'Shipping notification', 'This template is used to notify the destination customer of your pending shipment', 'Deprixa Pro has sent you package, shipping number #', 'date of shipment', 'Check the status of your shipment, link:', '1');
