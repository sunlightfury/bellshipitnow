...
<head>
    ...
    <?php
        // 	echo $lang['Customer'] 
	    if(Filter::$do == 'newsletter')
		echo 'Send Email';
	    elseif((Filter::$do =='main_client') && (Filter::$action == 'edit'))
		echo 'Edit Customer';
	    elseif((Filter::$do =='create_invoice') && (Filter::$action == 'create'))
        echo 'Create Customer Invoice';
        else
        echo 'Customer List';
    ?> | <?php echo $core->site_name ?></title>
    <!-- Custom CSS -->
                    ...
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">
                            <?php 
                                ...
                                elseif((Filter::$do =='main_client') && (Filter::$action == 'edit'))
                                echo 'Edit Customer';
                                elseif((Filter::$do =='customer_details') && (Filter::$action == 'details'))
                                echo 'Edit Customer';
                                else
                                echo 'Customer List';
                            ?>
