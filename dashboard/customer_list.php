            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title"><?php echo $lang['createshipment'] ?></h4>
                    </div>
                </div>
            </div>
                                    ...
                                    <table id="zero_config" class="table table-bordered table-condensed table-hover table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<a href="customer.php?do=sales_customer&amp;action=edit&amp;id=<?php echo $row->id; ?>&amp;cnum=<?php echo $row->customer_number; ?>" class='btn waves-effect waves-light btn-outline-primary top-btn' data-html="true" data-toggle="tooltip" data-original-title="<?php echo $lang['toolsee'] ?> <br><?php echo $row->fname;?> <?php echo $row->lname;?>"><i class="ti-receipt" aria-hidden="true"></i></span></a>
												</td>
												<td class="text-center">
												<?php if(($row->active)== 'n'){ ?>
