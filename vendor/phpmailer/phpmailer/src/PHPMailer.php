...
class PHPMailer
{
     ...
     * (e.g. "smtp1.bellshipitnow.com:25;smtp2.bellshipitnow.com").
     * You can also specify encryption type, for example:
     * (e.g. "tls://smtp1.bellshipitnow.com:587;ssl://smtp2.bellshipitnow.com:465").
     ...
     *
     * ```php
     * PHPMailer::validateAddress('user@bellshipitnow.com', function($address) {
     ...
     *                     [['joe@bellshipitnow.com', 'Joe User'], ['zoe@bellshipitnow.com', 'Zoe User']]
     *
     * @return string
     */
     ...
     *                    ['joe@bellshipitnow.com', 'Joe User']
     *
     * @return string
     */
